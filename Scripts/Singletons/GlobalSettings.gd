...
@onready var main_panel_style = load("res://Themes/Panels_themes/Main_panel_style_box_flat.tres")
@onready var buttons_panel_style = load("res://Themes/Panels_themes/Buttons_panel_style_box_flat.tres")
@onready var buttons_normal_style = load("res://Themes/Buttons_themes/Buttons_normal_style_box_flat.tres")
@onready var buttons_hover_style = load("res://Themes/Buttons_themes/Buttons_hover_style_box_flat.tres")
@onready var buttons_pressed_style = load("res://Themes/Buttons_themes/Buttons_pressed_style_box_flat.tres")
